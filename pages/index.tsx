...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Roshan Maharjan',", type: "array-item" },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Roshan <span className={styles.accentText}>Maharjan</span>
          </h1>

          <div className={styles.developerRole}>Full Stack Web Developer</div>

          <p className={styles.bio}>
            Experienced in building elegant, responsive web applications using
            modern technologies such as React, Node.js, and Tailwind CSS.
